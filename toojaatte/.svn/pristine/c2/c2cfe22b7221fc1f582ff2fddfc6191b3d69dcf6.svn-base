...
<body>
	<div class="container">
		...
		<article class="col-md-8">
				<div class="newsView">
					<div class="titleSection" style="padding: 5px; border-bottom: 4px;" >
						<div>${dto.press }</div>
						<div>
							<h2>${dto.title }</h2>
						</div>
